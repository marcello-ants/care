...
import PostAJobSchedulePagePC from '../schedule';
...
async function renderPage(mocks: any) {
  mockRouter = {
    push: jest.fn(),
    asPath: '/seeker/pc/schedule',
    pathname: '/seeker/pc/schedule',
  };
...
describe('PostAJobSchedulePagePC', () => {
  it('renders correctly', async () => {
    await renderPage(mocksList);

    await screen.findByText('When do you need pet care?');
